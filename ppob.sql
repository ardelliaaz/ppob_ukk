...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2019 at 07:57 AM
...
ALTER TABLE `penggunaan`
  ...
  ADD KEY `id_pelangagn` (`id_pelangagn`);
...
--
ALTER TABLE `penggunaan`
  ADD CONSTRAINT `penggunaan_ibfk_1` FOREIGN KEY (`id_pelangagn`) REFERENCES `pelanggan` (`id_pelanggan`);
